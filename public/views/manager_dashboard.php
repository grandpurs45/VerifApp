...
$canAnomaliesDashboard = isset($canAnomaliesDashboard) ? (bool) $canAnomaliesDashboard : false;
$canPharmacyDashboard = isset($canPharmacyDashboard) ? (bool) $canPharmacyDashboard : false;
$dashboardModuleOrder = isset($dashboardModuleOrder) && is_array($dashboardModuleOrder) ? $dashboardModuleOrder : [];
...
<?php if ($canAnomaliesDashboard || $canVerificationDashboard || $canPharmacyDashboard): ?>
    <section class="rounded-2xl bg-white shadow p-4 md:p-5">
        ...
        <div class="space-y-5">
            <?php foreach ($dashboardModuleOrder as $moduleKey): ?>
                <?php if ($moduleKey === 'anomalies' && $canAnomaliesDashboard): ?>
                ...
                <?php if ($moduleKey === 'verifications' && $canVerificationDashboard): ?>
                    <article class="rounded-2xl border border-slate-200 p-4">
                        <div class="mb-3 flex items-center justify-between">
                ...
                <?php if ($moduleKey === 'pharmacy' && $canPharmacyDashboard): ?>
                    <article class="rounded-2xl border border-slate-200 p-4">
                        <div class="mb-3 flex items-center justify-between">
