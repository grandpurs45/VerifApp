...
<body class="bg-slate-100 min-h-screen text-slate-900">
    <main class="max-w-6xl mx-auto p-4 md:p-8">
        <header class="mb-6">
            ...
            <h1 class="text-3xl font-bold mt-2">Suivi des anomalies</h1>
            <p class="text-slate-600 mt-1">Vue simple: qui fait quoi, et quoi traiter en priorite.</p>
        </header>
        ...
        <?php if (!$anomaliesAvailable): ?>
            <section class="mb-4 rounded-xl border border-amber-200 bg-amber-50 p-4 text-amber-700 text-sm">
                        ...
                        <div class="flex flex-wrap items-start justify-between gap-3">
                            <div>
                                ...
                                <p class="text-sm text-slate-500 mt-1">
                                    Zone: <?= htmlspecialchars((string) $anomaly['controle_zone'], ENT_QUOTES, 'UTF-8') ?>
                                </p>
                                <p class="text-sm text-slate-500 mt-1">
                        ...
                        <div class="mt-3 text-sm">
                            <div class="inline-flex items-center gap-2 rounded-xl px-3 py-2 <?= $isAssigned ? 'bg-sky-100 border border-sky-200 text-sky-800' : 'bg-red-600 border border-red-700 text-white' ?>">
                                ...
                                <strong class="text-sm">
                                    <?= htmlspecialchars((string) ($anomaly['assigne_nom'] ?? 'Non assignee'), ENT_QUOTES, 'UTF-8') ?>
                                </strong>
                            </div>
                            <p class="mt-1">
